...
wf=Path(".github/workflows/manual_edge_sheet_e2e.yml"); L=wf.read_text().splitlines()
...
for want in ["builder_stdout.log","builder_stderr.log","run_debug.txt","run_debug.json","slip_builder_debug.json"]:
    if want not in present:
        L.insert(j, indent+want); j+=1
wf.write_text("\n".join(L)); print("OK")
